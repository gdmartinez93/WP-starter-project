...
if ( ! function_exists( 'storefront_site_branding' ) ) {
	...
	function storefront_site_branding() {
		?>
		<div class="header__brand site-branding">
...
if ( ! function_exists( 'storefront_primary_navigation_wrapper' ) ) {
	...
	function storefront_primary_navigation_wrapper() {
		echo '<div class="header__navigation storefront-primary-navigation"><div class="col-full">';
	}
}
...
if ( ! function_exists( 'storefront_header_container' ) ) {
	...
	function storefront_header_container() {
		echo '<div class="storefront-container col-full">';
	}
}
