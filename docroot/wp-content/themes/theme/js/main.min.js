...
const $elem = _node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()('.a-field');
if ($elem.length > 0) {
  $elem.each(function () {
    const $input = _node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('.a-field__input');
    $input.on('focusin', function () {
      _node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().addClass('is-focus');
    });
    $input.on('focusout', function () {
      _node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().removeClass('is-focus');
    });
  });
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _atoms_field_field__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./atoms/field/field */ "./src/atoms/field/field.js");
/* harmony import */ var _organisms_header_header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./organisms/header/header */ "./src/organisms/header/header.js");
/* harmony import */ var _organisms_portfolio_portfolio_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./organisms/portfolio/portfolio.js */ "./src/organisms/portfolio/portfolio.js");
/* harmony import */ var _pages_home_page_home_page_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/home-page/home-page.js */ "./src/pages/home-page/home-page.js");
...
const $header = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.o-header');
...
$menuAction.on('click', 'button', function (event) {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).children().hasClass('is-active')) {
     if ($header.hasClass('show-menu')) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).children().removeClass('is-active');
    ...
    // $(this).children().add($toolbar).addClass('is-active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).children().addClass('is-active');
...
/***/ "./src/organisms/portfolio/portfolio.js":
/*!**********************************************!*\
  !*** ./src/organisms/portfolio/portfolio.js ***!
  \**********************************************/
/*! no exports provided */
...
const $portfolio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.o-portfolio');
const $items = $portfolio.find('.o-portfolio__item');

$items.on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass('is-full').siblings().removeClass('is-full');
});

if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() < 768) {
  $items.on('click', function () {
    $portfolio.toggleClass('mobileFunction');
  });
}

if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() >= 768) {
  $items.hover(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings(':not(.is-full):not(.is-title)').toggleClass('opacity');
  });
}
...
class CustomHeaderSlider {
  ...
  */
  ...
  init() {
    const that = this;
    this.swiper = new Swiper('.p-home-page__header .slider-element', {
      speed: 1500,
      // loop: true,
...
const $elem = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.p-home-page');
const $header = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.o-header');
const smCtroller = new ScrollMagic.Controller();

const handlerHeader = () => {
  particlesJS.load('header-homepage-bg', pathTheme + '/js/particles.json', function() {
    console.log('callback - particles.js config loaded');
  });
  
  const headerSlider = new CustomHeaderSlider();
  setInterval(() => {
...
const handlerAboutUs = () => {
  const scene = new ScrollMagic.Scene({
    ...
    .setClassToggle('#about-us', 'show-content')
    .addIndicators({ name: 'about-us' })
    .addTo(smCtroller);
}

const handlerWhatWeDo = () => {
  const scene = new ScrollMagic.Scene({
    ...
    .setClassToggle('#what-we-do', 'show-content')
...
const handlerProjects = () => {
  const scene = new ScrollMagic.Scene({
    ...
    .setClassToggle('#projects', 'show-content')
    .addIndicators({ name: 'projects' })
    .addTo(smCtroller);

  const $projects = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.p-home-page__projects .project');
...
const handlerFlowChart = () => {
  /* eslint-disable no-unused-vars */
  const pinScene = new ScrollMagic.Scene({
    triggerElement: '#flow-chart',
    triggerHook: 0,
    offset: -150,
    duration: '120%'
  })
    .setPin('#flow-chart', { pushFollowers: false })
    .addTo(smCtroller)

  const $items = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.p-home-page__flow-chart .item');
  let initialOffSetTitle = -110;
  let initialOffSetContent = -70;
  $items.each(function (index, elem) {
    const scene1 = new ScrollMagic.Scene({
      triggerElement: '#flow-chart',
      triggerHook: 0,
      offset: index == 0 ? initialOffSetTitle : initialOffSetTitle,
      reverse: true
    })
      .setClassToggle(this, 'show-title')
      .addIndicators({ name: `title-${index}` })
      .addTo(smCtroller);
    initialOffSetTitle = index == 0 ? initialOffSetTitle + 100 : initialOffSetTitle + (140 * index);

    const scene2 = new ScrollMagic.Scene({
      triggerElement: '#flow-chart',
      triggerHook: 0,
      offset: index == 0 ? initialOffSetContent : initialOffSetContent,
      reverse: true
    })
      .setClassToggle(this, 'show-content')
      .addIndicators({ name: `content-${index}` })
      .addTo(smCtroller);
    initialOffSetContent = index == 0 ? initialOffSetContent + 120 : initialOffSetContent + (160 * index);
  });
  /* eslint-enable no-unused-vars */
}
...
const handlerClients = () => {
  const scene = new ScrollMagic.Scene({
    ...
    .setClassToggle('#clients', 'show-content')
    .addIndicators({ name: 'clients' })
    .addTo(smCtroller);
}

const handlerTestimonials = () => {
  const scene = new ScrollMagic.Scene({
    ...
    .setClassToggle('#testimonials', 'show-content')
    .addIndicators({ name: 'testimonials' })
    .addTo(smCtroller);

  const testimonialSlider = new Swiper('.p-home-page__testimonials .slider', {
    speed: 200,
    slidesPerView: 3,
    centeredSlides: true,
    initialSlide: 1,
    lazy: true,
    pagination: {
      el: '.p-home-page__testimonials .slider .swiper-pagination',
      type: 'bullets',
      dynamicBullets: true
    },
  });
