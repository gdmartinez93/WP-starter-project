...
add_filter('woocommerce_get_price_html', 'nutripower_percent_of_on_sale', 10, 2);
function nutripower_percent_of_on_sale($price, $product) {
...
add_filter('woocommerce_product_tabs', 'nutripower_removetabs_product', 11, 1);
function nutripower_removetabs_product($tabs) {
    unset($tabs['pwb_tab']);
    return $tabs;
}
