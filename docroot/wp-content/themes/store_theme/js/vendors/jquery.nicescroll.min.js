...
!function(e) {
    ...
    l ? window.cancelAnimationFrame || (a = function(e) {}
    ) : (l = function(e, o) {
    ...
    var c = window.MutationObserver || window.WebKitMutationObserver || !1
      ...
      , h = function() {
        ...
        var e = document.createElement("DIV")
          ...
          , i = {};
        return i.haspointerlock = "pointerLockElement"in document || "webkitPointerLockElement"in document || "mozPointerLockElement"in document,
      ...
      , p = function(e, u) {
        ...
        function v(e, o, t) {
            var r, i;
            if (0 == e.deltaMode ? (r = -Math.floor(e.deltaX * (b.opt.mousescrollstep / 54)),
            i = -Math.floor(e.deltaY * (b.opt.mousescrollstep / 54))) : 1 == e.deltaMode && (r = -Math.floor(e.deltaX * b.opt.mousescrollstep),
            i = -Math.floor(e.deltaY * b.opt.mousescrollstep)),
            o && b.opt.oneaxismousemode && 0 == r && i && (r = i,
            i = 0,
            t && (r < 0 ? b.getScrollLeft() >= b.page.maxw : b.getScrollLeft() <= 0) && (i = r,
            r = 0)),
            b.isrtlmode && (r = -r),
            r && (b.scrollmom && b.scrollmom.stop(),
            b.lastdeltax += r,
        ...
        e)
            for (var y in b.opt)
                void 0 !== e[y] && (b.opt[y] = e[y]);
        if (b.opt.disablemutationobserver && (c = !1),
        this.doc = b.opt.doc,
        ...
        "auto" == this.opt.rtlmode) {
            ...
            "horizontal-tb" == S || "lr-tb" == S || "" == S ? (this.isrtlmode = "rtl" == x.css("direction"),
            this.isvertical = !1) : (this.isrtlmode = "vertical-rl" == S || "tb" == S || "tb-rl" == S || "rl-tb" == S,
        ...
        this.isrtlmode ? this.isvertical ? this.hasreversehr = !(z.iswebkit || z.isie || z.isie11) : this.hasreversehr = !(z.iswebkit || z.isie && !z.isie10 && !z.isie11) : this.hasreversehr = !1,
        this.istouchcapable = !1,
        z.cantouch || !z.hasw3ctouch && !z.hasmstouch ? !z.cantouch || z.isios || z.isandroid || !z.iswebkit && !z.ismozilla || (this.istouchcapable = !0) : this.istouchcapable = !0,
        b.opt.enablemouselockapi || (z.hasmousecapture = !1,
        z.haspointerlock = !1),
        ...
        this.ishwscroll) {
            ...
            z.hastranslate3d && z.isios && this.doc.css("-webkit-backface-visibility", "hidden"),
            ...
            z.hastranslate3d && b.opt.enabletranslate3d ? (this.setScrollTop = function(e, o) {
                ...
                b.doc.css(z.trstyle, "translate3d(" + b.doc.translate.tx + "," + b.doc.translate.ty + ",0px)"),
            ...
            this.setScrollLeft = function(e, o) {
                ...
                b.doc.translate.y = e,
                b.doc.translate.ty = -1 * e + "px",
                b.doc.css(z.trstyle, "translate(" + b.doc.translate.tx + "," + b.doc.translate.ty + ")"),
                o || b.notifyScrollEvent(b.win[0])
            }
            ,
            this.setScrollLeft = function(e, o) {
            ...
            this.setScrollLeft = function(e) {
                return setTimeout(function() {
                    if (b)
                        return b.hasreversehr && (e = b.detected.ismozilla ? -(b.page.maxw - e) : b.page.maxw - e),
        ...
        this.updateScrollBar = function(e) {
            ...
            if (b.ishwscroll)
                ...
                o.left += b.rail.align ? b.win.outerWidth() - g(b.win, "border-right-width") - b.rail.width : g(b.win, "border-left-width"),
                (t = b.opt.railoffset) && (t.top && (o.top += t.top),
                ...
                b.railh && !b.railslocked) {
                    ...
                    (t = b.opt.railhoffset) && (t.top && (o.top += t.top),
                    t.left && (o.left += t.left));
        ...
        this.doRailClick = function(e, o, t) {
            var r, i, n, s;
            b.railslocked || (b.cancelEvent(e),
            o ? (r = t ? b.doScrollLeft : b.doScrollTop)(n = t ? (e.pageX - b.railh.offset().left - b.cursorwidth / 2) * b.scrollratio.x : (e.pageY - b.rail.offset().top - b.cursorheight / 2) * b.scrollratio.y) : (r = t ? b.doScrollLeftBy : b.doScrollBy,
            n = t ? b.scroll.x : b.scroll.y,
            s = t ? e.pageX - b.railh.offset().left : e.pageY - b.rail.offset().top,
        ...
        this.init = function() {
            ...
            if (z.isoperamini)
                return !0;
            if (z.isandroid && !("hidden"in document))
                return !0;
            ...
            if (b.opt.emulatetouch = b.opt.emulatetouch || b.opt.touchbehavior,
            b.zindex = "auto",
            b.ispage || "auto" != b.opt.zindex ? b.zindex = b.opt.zindex : b.zindex = f() || "auto",
            ...
            !b.ispage || !z.cantouch && !z.isieold && !z.isie9mobile) {
                ...
                b.ispage && z.isie7 && ("BODY" == b.doc[0].nodeName ? b.css(s("html"), {
                    "overflow-y": "hidden"
                }) : "HTML" == b.doc[0].nodeName && b.css(s("body"), e)),
                !z.isios || b.ispage || b.haswrapper || b.css(s("body"), {
                ...
                for (var p in h)
                    u = h[p],
                    (d = b.opt.railpadding[u]) ? a.css("padding-" + u, d + "px") : b.opt.railpadding[u] = 0;
                a.append(l),
                a.width = Math.max(parseFloat(b.opt.cursorwidth), l.outerWidth()),
                a.css({
                    width: a.width + "px",
                    zIndex: b.zindex,
                ...
                b.rail.drag = !1;
                var g = !1;
                !b.opt.boxzoom || b.ispage || z.isieold || (g = document.createElement("div"),
                ...
                z.cantouch && b.opt.gesturezoom && (b.ongesturezoom = function(e) {
                    return e.scale > 1.5 && b.doZoomIn(e),
                    e.scale < .8 && b.doZoomOut(e),
                    b.cancelEvent(e)
                }
                ,
                ...
                w.height = Math.max(parseFloat(b.opt.cursorwidth), l.outerHeight()),
                w.css({
                    height: w.height + "px",
                    zIndex: b.zindex,
                    background: b.opt.background
                ...
                b.ispage)
                    ...
                    if (b.ishwscroll) {
                        ...
                        0 == /fixed|absolute/.test(b.viewport.css("position")) && b.css(b.viewport, {
                            position: "relative"
                        })),
                        a.css({
                            position: y
                    ...
                    z.isie && b.opt.disableoutline && b.win.attr("hideFocus", "true"),
                    z.iswebkit && b.opt.disableoutline && b.win.css("outline", "none")
                }
                if (!1 === b.opt.autohidemode ? (b.autohidedom = !1,
                b.rail.css({
                    opacity: b.opt.cursoropacitymax
                }),
                b.railh && b.railh.css({
                    opacity: b.opt.cursoropacitymax
                })) : !0 === b.opt.autohidemode || "leave" === b.opt.autohidemode ? (b.autohidedom = s().add(b.rail),
                z.isie8 && (b.autohidedom = b.autohidedom.add(b.cursor)),
                b.railh && (b.autohidedom = b.autohidedom.add(b.railh)),
                b.railh && z.isie8 && (b.autohidedom = b.autohidedom.add(b.cursorh))) : "scroll" == b.opt.autohidemode ? (b.autohidedom = s().add(b.rail),
                b.railh && (b.autohidedom = b.autohidedom.add(b.railh))) : "cursor" == b.opt.autohidemode ? (b.autohidedom = s().add(b.cursor),
                ...
                z.isie9mobile) {
                    ...
                    b.onmangotouch = function() {
                        var e = b.getScrollTop()
                          , o = b.getScrollLeft();
                        if (e == b.scrollmom.lastscrolly && o == b.scrollmom.lastscrollx)
                            return !0;
                        ...
                        if (0 != Math.round(Math.sqrt(Math.pow(r, 2) + Math.pow(t, 2)))) {
                            var i = t < 0 ? -1 : 1
                              , n = r < 0 ? -1 : 1
                              , s = +new Date;
                            if (b.mangotouch.lazy && clearTimeout(b.mangotouch.lazy),
                            s - b.mangotouch.tm > 80 || b.mangotouch.dry != i || b.mangotouch.drx != n)
                                b.scrollmom.stop(),
                                ...
                                b.scrollmom.stop(),
                                b.scrollmom.update(b.mangotouch.sx - r, b.mangotouch.sy - t),
                                b.mangotouch.tm = s;
                                var l = Math.max(Math.abs(b.mangotouch.ly - e), Math.abs(b.mangotouch.lx - o));
                                b.mangotouch.ly = e,
                                b.mangotouch.lx = o,
                                l > 2 && (b.mangotouch.lazy = setTimeout(function() {
                                    b.mangotouch.lazy = !1,
                                    b.mangotouch.dry = 0,
                                    b.mangotouch.drx = 0,
                                    b.mangotouch.tm = 0,
                    ...
                    if (z.cantouch || b.istouchcapable || b.opt.emulatetouch || z.hasmstouch) {
                            ...
                            !b.railslocked) {
                                ...
                                if (z.hasmstouch)
                                    for (o = !!e.target && e.target; o; ) {
                                        ...
                                        if (t.length > 0 && t[0].me == b.me)
                                            break;
                                        if (t.length > 0)
                                            return !1;
                                        if ("DIV" == o.nodeName && o.id == b.id)
                                            break;
                                        o = !!o.parentNode && o.parentNode
                                    }
                                if (b.cancelScroll(),
                                (o = b.getTarget(e)) && /INPUT/i.test(o.nodeName) && /range/i.test(o.type))
                                ...
                                b.ispage || !b.opt.directionlockdeadzone)
                                    ...
                                    !b.rail.scrollable && b.railh.scrollable ? b.rail.drag.ck = l > 0 && "v" : b.rail.scrollable && !b.railh.scrollable ? b.rail.drag.ck = a > 0 && "h" : b.rail.drag.ck = !1,
                                ...
                                !z.cantouch && !this.istouchcapable && !e.pointerType) {
                                    if (!(!!o && /INPUT|SELECT|BUTTON|TEXTAREA/i.test(o.nodeName)))
                                        return !b.ispage && z.hasmousecapture && o.setCapture(),
                                        b.opt.emulatetouch ? (o.onclick && !o._onclick && (o._onclick = o.onclick,
                        ...
                        b.ontouchend = function(e) {
                            ...
                            if (2 == b.rail.drag.pt) {
                                ...
                                if (b.rail.drag = !1,
                                b.hasmoving && (b.scrollmom.doMomentum(),
                                b.lastmouseup = !0,
                                b.hideCursor(),
                        ...
                        b.ontouchmove = function(e, o) {
                            if (!b.rail.drag)
                                return !1;
                            if (e.targetTouches && b.opt.preventmultitouchscrolling && e.targetTouches.length > 1)
                                return !1;
                            if (e.pointerType && 2 != e.pointerType && "touch" != e.pointerType)
                                return !1;
                            if (z.isandroid && b.cancelEvent(e),
                            2 == b.rail.drag.pt) {
                                ...
                                var l = e.clientY + r
                                  ...
                                  , d = c - b.rail.drag.x
                                  , u = b.rail.drag.st - a;
                                b.ishwscroll && b.opt.bouncescroll ? u < 0 ? u = Math.round(u / 2) : u > b.page.maxh && (u = b.page.maxh + Math.round((u - b.page.maxh) / 2)) : (u < 0 && (u = 0,
                                l = 0),
                                u > b.page.maxh && (u = b.page.maxh,
                                l = 0));
                                var h;
                                b.railh && b.railh.scrollable && (h = b.isrtlmode ? d - b.rail.drag.sl : b.rail.drag.sl - d,
                                b.ishwscroll && b.opt.bouncescroll ? h < 0 ? h = Math.round(h / 2) : h > b.page.maxw && (h = b.page.maxw + Math.round((h - b.page.maxw) / 2)) : (h < 0 && (h = 0,
                                c = 0),
                                h > b.page.maxw && (h = b.page.maxw,
                                c = 0)));
                                var p = !1;
                                if (b.rail.drag.dl)
                                    p = !0,
                                    "v" == b.rail.drag.dl ? h = b.rail.drag.sl : "h" == b.rail.drag.dl && (u = b.rail.drag.st);
                                else {
                                    var m = Math.abs(a)
                                      , f = Math.abs(d)
                                    ...
                                    if ("v" == b.rail.drag.ck) {
                                        if (m > g && f <= .3 * m)
                                            ...
                                            !0;
                                        f > g && (b.rail.drag.dl = "f",
                                        s("body").scrollTop(s("body").scrollTop()))
                                    } else if ("h" == b.rail.drag.ck) {
                                        if (f > g && m <= .3 * f)
                                            return b.rail.drag = !1,
                                            !0;
                                        m > g && (b.rail.drag.dl = "f",
                                ...
                                if (b.synched("touchmove", function() {
                                    ...
                                    b.railh && b.railh.scrollable ? (b.setScrollLeft(h),
                                    b.showCursor(u, h)) : b.showCursor(u),
                        ...
                        b.ontouchstartCursor = function(e, o) {
                            if (!b.rail.drag || 3 == b.rail.drag.pt) {
                                ...
                                var t = b.getTarget(e);
                                return !b.ispage && z.hasmousecapture && t.setCapture(),
                                b.isiframe && !z.hasmousecapture && (b.saved.csspointerevents = b.doc.css("pointer-events"),
                                b.css(b.doc, {
                                    "pointer-events": "none"
                                })),
                                b.cancelEvent(e)
                        ...
                        b.ontouchendCursor = function(e) {
                            if (b.rail.drag) {
                                if (z.hasmousecapture && document.releaseCapture(),
                                b.isiframe && !z.hasmousecapture && b.doc.css("pointer-events", b.saved.csspointerevents),
                                3 != b.rail.drag.pt)
                                    return;
                                return b.rail.drag = !1,
                                b.cancelEvent(e)
                    ...
                    b.onmouseup = function(e) {
                        if (b.rail.drag)
                            return 1 != b.rail.drag.pt || (z.hasmousecapture && document.releaseCapture(),
                            b.isiframe && !z.hasmousecapture && b.doc.css("pointer-events", b.saved.csspointerevents),
                            b.rail.drag = !1,
                    ...
                    b.onmousemove = function(e) {
                        if (b.rail.drag) {
                            ...
                            return b.synched("mousemove", function() {
                                ...
                                b.rail.drag.hr ? b.hasreversehr ? b.doScrollLeft(b.scrollvaluemaxw - Math.round(b.scroll.x * b.scrollratio.x), b.opt.cursordragspeed) : b.doScrollLeft(Math.round(b.scroll.x * b.scrollratio.x), b.opt.cursordragspeed) : b.doScrollTop(Math.round(b.scroll.y * b.scrollratio.y), b.opt.cursordragspeed))
                            }),
                            b.cancelEvent(e)
                        }
                        b.checkarea = 0
                    ...
                    b.bind(document, "pointermove", b.ontouchmove)) : z.hasmstouch ? (b.css(b.ispage ? s("html") : b.win, {
                    ...
                    b.bind(b.cursor, "contextmenu", function(e) {
                        e.preventDefault()
                    })) : z.cantouch && (b.bind(b.win, "touchstart", b.ontouchstart, !1, !0),
                    ...
                    b.opt.emulatetouch && (b.bind(b.win, "mousedown", b.ontouchstart, !1, !0),
                    b.bind(document, "mouseup", b.ontouchend, !1, !0),
                    b.bind(document, "mousemove", b.ontouchmove, !1, !0)),
                    (b.opt.cursordragontouch || !z.cantouch && !b.opt.emulatetouch) && (b.rail.css({
                        cursor: "default"
                    }),
                    b.railh && b.railh.css({
                        cursor: "default"
                    ...
                    b.opt.cursordragontouch && (this.istouchcapable || z.cantouch) && (b.bind(b.cursor, "touchstart", b.ontouchstartCursor),
                    b.bind(b.cursor, "touchmove", b.ontouchmoveCursor),
                    b.bind(b.cursor, "touchend", b.ontouchendCursor),
                    b.cursorh && b.bind(b.cursorh, "touchstart", function(e) {
                    ...
                    z.cantouch || b.opt.emulatetouch ? (b.bind(z.hasmousecapture ? b.win : document, "mouseup", b.ontouchend),
                    b.onclick && b.bind(document, "click", b.onclick),
                    b.opt.cursordragontouch ? (b.bind(b.cursor, "mousedown", b.onmousedown),
                    b.bind(b.cursor, "mouseup", b.onmouseup),
                    b.cursorh && b.bind(b.cursorh, "mousedown", function(e) {
                        b.onmousedown(e, !0)
                    }),
                    ...
                    b.railh && b.bind(b.railh, "mousedown", function(e) {
                        e.preventDefault()
                    }))) : (b.bind(z.hasmousecapture ? b.win : document, "mouseup", b.onmouseup),
                    ...
                    b.opt.enablemousewheel && (b.isiframe || b.mousewheel(z.isie && b.ispage ? document : b.win, b.onmousewheel),
                    b.mousewheel(b.rail, b.onmousewheel),
                    b.railh && b.mousewheel(b.railh, b.onmousewheelhr)),
                    b.ispage || z.cantouch || /HTML|^BODY/.test(b.win[0].nodeName) || (b.win.attr("tabindex") || b.win.attr({
                        tabindex: r++
                    }),
                ...
                if (b.onkeypress = function(e) {
                    ...
                    if (b.hasfocus || b.hasmousefocus && !o || b.ispage && !o && !t) {
                        ...
                        case 37:
                        case 63232:
                            b.railh && (n ? b.doScrollLeft(0) : b.doScrollLeftBy(72),
                            a = !0);
                            break;
                        case 39:
                        case 63234:
                            b.railh && (n ? b.doScrollLeft(b.page.maxw) : b.doScrollLeftBy(-72),
                            a = !0);
                            break;
                        case 33:
                        case 63276:
                        ...
                        case 35:
                        case 63275:
                            b.railh && n ? b.doScrollPos(b.page.maxw, b.page.maxh) : b.doScrollTo(b.page.maxh),
                            a = !0;
                            break;
                        case 32:
                            b.opt.spacebarenabled && (l ? b.doScrollBy(b.view.h) : b.doScrollBy(-b.view.h),
                            a = !0);
                            break;
                        case 27:
                ...
                ,
                b.opt.enablekeyboard && b.bind(document, z.isopera && !z.isopera12 ? "keypress" : "keydown", b.onkeypress),
                ...
                b.opt.enableobserver && (b.isie11 || !1 === c || (b.observerbody = new c(function(e) {
                    if (e.forEach(function(e) {
                        if ("attributes" == e.type)
                            return s("body").hasClass("modal-open") && s("body").hasClass("modal-dialog") && !s.contains(s(".modal-dialog")[0], b.doc[0]) ? b.hide() : b.show()
                    }),
                ...
                b.observerremover.observe(b.win[0].parentNode, {
                    ...
                    attributes: !1,
                    subtree: !1
                })) : (b.bind(b.win, z.isie && !z.isie9 ? "propertychange" : "DOMAttrModified", b.onAttributeChange),
                z.isie9 && b.win[0].attachEvent("onpropertychange", b.onAttributeChange),
                b.bind(b.win, "DOMNodeRemoved", function(e) {
                    e.target == b.win[0] && b.remove()
                })))),
                !b.ispage && b.opt.boxzoom && b.bind(window, "resize", b.resizeZoom),
                b.istextarea && (b.bind(b.win, "keydown", b.lazyResize),
            ...
            if ("IFRAME" == this.doc[0].nodeName) {
                var L = function() {
                    ...
                    z.isios && b.haswrapper && b.css(s(o.body), {
                    ...
                    b.opt.enablekeyboard && b.bind(o, z.isopera ? "keypress" : "keydown", b.onkeypress),
                    z.cantouch ? (b.bind(o, "touchstart", b.ontouchstart),
                    b.bind(o, "touchmove", b.ontouchmove)) : b.opt.emulatetouch && (b.bind(o, "mousedown", b.ontouchstart),
                    ...
                    b.zoom && (b.opt.dblclickzoom && b.bind(o, "dblclick", b.doZoom),
        ...
        this.showCursor = function(e, o) {
            ...
            b.rail) {
                ...
                b.cursoractive = !0),
                b.rail.drag && 1 == b.rail.drag.pt || (void 0 !== e && !1 !== e && (b.scroll.y = Math.round(1 * e / b.scrollratio.y)),
                void 0 !== o && (b.scroll.x = Math.round(1 * o / b.scrollratio.x))),
                b.cursor.css({
        ...
        this.onResize = function(e, o) {
            ...
            b.page.maxh == t && b.page.maxw == r && b.view.w == i.w && b.view.h == i.h) {
                if (b.ispage)
                    return b;
                var n = b.win.offset();
                if (b.lastposition) {
            ...
            return 0 == b.page.maxh ? (b.hideRail(),
            b.scrollvaluemax = 0,
            b.scroll.y = 0,
            b.scrollratio.y = 0,
            b.cursorheight = 0,
            b.setScrollTop(0),
            b.rail && (b.rail.scrollable = !1)) : (b.page.maxh -= b.opt.railpadding.top + b.opt.railpadding.bottom,
            b.rail.scrollable = !0),
            ...
            b.cursorwidth = 0,
            b.setScrollLeft(0),
            b.railh && (b.railh.scrollable = !1)) : (b.page.maxw -= b.opt.railpadding.left + b.opt.railpadding.right,
            b.railh && (b.railh.scrollable = b.opt.horizrailenabled)),
            b.railslocked = b.locked || 0 == b.page.maxh && 0 == b.page.maxw,
            b.railslocked ? (b.ispage || b.updateScrollBar(b.view),
            !1) : (b.hidden || b.visibility ? !b.railh || b.hidden || b.railh.visibility || b.showRailHr() : b.showRail().showRailHr(),
            ...
            b.railh && (b.railh.width = b.page.maxh > 0 ? b.view.w - b.rail.width : b.view.w,
            b.scrollvaluemaxw = b.railh.width - b.cursorwidth - b.cursorh.wborder - (b.opt.railpadding.left + b.opt.railpadding.right)),
        ...
        this.showRail = function() {
            return 0 == b.page.maxh || !b.ispage && "none" == b.win.css("display") || (b.visibility = !0,
            b.rail.visibility = !0,
        ...
        this.showRailHr = function() {
            return b.railh ? (0 == b.page.maxw || !b.ispage && "none" == b.win.css("display") || (b.railh.visibility = !0,
            b.railh.css("display", "block")),
            b) : b
        }
        ,
        this.hideRail = function() {
            return b.visibility = !1,
            b.rail.visibility = !1,
        ...
        this.hideRailHr = function() {
            return b.railh ? (b.railh.visibility = !1,
        ...
        this.remove = function() {
            ...
            for (var e in b.delaylist)
                b.delaylist[e] && a(b.delaylist[e].h);
            b.doZoomOut(),
            b.unbindAll(),
            z.isie9 && b.win[0].detachEvent("onpropertychange", b.onAttributeChange),
        ...
        this.onmousewheel = function(e) {
            if (!b.wheelprevented) {
                ...
                if (b.rail.drag)
                    return b.cancelEvent(e);
                if ("auto" == b.opt.oneaxismousemode && 0 != e.deltaX && (b.opt.oneaxismousemode = !1),
                b.opt.oneaxismousemode && 0 == e.deltaX && !b.rail.scrollable)
                    return !b.railh || !b.railh.scrollable || b.onmousewheelhr(e);
                var o = +new Date
                  , t = !1;
                if (b.opt.preservenativescrolling && b.checkarea + 600 < o && (b.nativescrollingarea = b.isScrollable(e),
                t = !0),
                b.checkarea = o,
                b.nativescrollingarea)
                    return !0;
                var r = v(e, !1, t);
                return r && (b.checkarea = 0),
                r
            }
        }
        ,
        this.onmousewheelhr = function(e) {
            if (!b.wheelprevented) {
                ...
                var o = +new Date
                  , t = !1;
                return b.opt.preservenativescrolling && b.checkarea + 600 < o && (b.nativescrollingarea = b.isScrollable(e),
                t = !0),
                b.checkarea = o,
                !!b.nativescrollingarea || (b.railslocked ? b.cancelEvent(e) : v(e, !0, t))
            }
        }
        ,
        this.stop = function() {
        ...
        b.opt.smoothscroll ? b.ishwscroll && z.hastransition && b.opt.usetransition && b.opt.smoothscroll ? (this.prepareTransition = function(e, o) {
            ...
            return b.lasttransitionstyle && b.lasttransitionstyle == r || (b.lasttransitionstyle = r,
        ...
        this.doScrollPos = function(e, o, t) {
            var r = b.getScrollTop()
              , i = b.getScrollLeft();
            return ((b.newscrolly - r) * (o - r) < 0 || (b.newscrollx - i) * (e - i) < 0) && b.cancelScroll(),
            0 == b.opt.bouncescroll && (o < 0 ? o = 0 : o > b.page.maxh && (o = b.page.maxh),
            e < 0 ? e = 0 : e > b.page.maxw && (e = b.page.maxw)),
            (!b.scrollrunning || e != b.newscrollx || o != b.newscrolly) && (b.newscrolly = o,
            b.newscrollx = e,
            b.newscrollspeed = t || !1,
            !b.timer && void (b.timer = setTimeout(function() {
                ...
                if (b.newscrollspeed && b.newscrollspeed <= 1 && (s *= b.newscrollspeed),
                ...
                s > 0) {
                    ...
                    z.transitionend ? b.scrollendtrapped || (b.scrollendtrapped = !0,
                    b.bind(b.doc, z.transitionend, b.onScrollTransitionEnd, !1)) : (b.scrollendtrapped && clearTimeout(b.scrollendtrapped),
                    b.scrollendtrapped = setTimeout(b.onScrollTransitionEnd, s));
                    var a = t
                      , c = r;
                    b.timerscroll = {
        ...
        this.onScrollTransitionEnd = function() {
            b.scrollendtrapped && b._unbind(b.doc[0], z.transitionend, b.onScrollTransitionEnd),
            b.scrollendtrapped = !1,
            b.prepareTransition(0),
            b.timerscroll && b.timerscroll.tm && clearInterval(b.timerscroll.tm),
            b.timerscroll = !1;
        ...
        this.doScrollPos = function(e, o, t) {
            function r() {
                if (b.cancelAnimationFrame)
                    return !0;
                if (b.scrollrunning = !0,
                h = 1 - h)
                    return b.timer = l(r) || 1;
                var e, o, t = 0, i = o = b.getScrollTop();
                b.dst.ay ? (((s = (i = b.bzscroll ? b.dst.py + b.bzscroll.getNow() * b.dst.ay : b.newscrolly) - o) < 0 && i < b.newscrolly || s > 0 && i > b.newscrolly) && (i = b.newscrolly),
                b.setScrollTop(i),
                i == b.newscrolly && (t = 1)) : t = 1;
                var n = e = b.getScrollLeft();
                if (b.dst.ax) {
                    var s = (n = b.bzscroll ? b.dst.px + b.bzscroll.getNow() * b.dst.ax : b.newscrollx) - e;
                    (s < 0 && n < b.newscrollx || s > 0 && n > b.newscrollx) && (n = b.newscrollx),
                    b.setScrollLeft(n),
                    n == b.newscrollx && (t += 1)
                } else
                    t += 1;
                ...
                b.bzscroll = !1,
                b.scrollrunning = !1,
                i < 0 ? i = 0 : i > b.page.maxh && (i = Math.max(0, b.page.maxh)),
                n < 0 ? n = 0 : n > b.page.maxw && (n = b.page.maxw),
                n != b.newscrollx || i != b.newscrolly ? b.doScrollPos(n, i) : b.onscrollend && b.triggerScrollEnd()) : b.timer = l(r) || 1
            }
            ...
            var i = b.getScrollTop()
              , n = b.getScrollLeft();
            ((b.newscrolly - i) * (o - i) < 0 || (b.newscrollx - n) * (e - n) < 0) && b.cancelScroll(),
            b.newscrolly = o,
            b.newscrollx = e,
            b.bouncescroll && b.rail.visibility || (b.newscrolly < 0 ? b.newscrolly = 0 : b.newscrolly > b.page.maxh && (b.newscrolly = b.page.maxh)),
            b.bouncescroll && b.railh.visibility || (b.newscrollx < 0 ? b.newscrollx = 0 : b.newscrollx > b.page.maxw && (b.newscrollx = b.page.maxw)),
            b.dst = {},
            b.dst.x = e - n,
            b.dst.y = o - i,
            b.dst.px = n,
            ...
            d = o,
            b.dst.ay = 1,
            b.dst.py = 0) : 0 == b.dst.y && (c = n,
            d = e,
            b.dst.ax = 1,
            b.dst.px = 0);
            var u = b.getTransitionSpeed(s);
            if (t && t <= 1 && (u *= t),
            b.bzscroll = u > 0 && (b.bzscroll ? b.bzscroll.update(d, u) : new k(c,d,u,0,1,0,1)),
            !b.timer) {
                (i == b.page.maxh && o >= b.page.maxh || n == b.page.maxw && e >= b.page.maxw) && b.checkContentSize();
                var h = 1;
                if (b.cancelAnimationFrame = !1,
                b.timer = 1,
                ...
                r(),
                (i == b.page.maxh && o >= i || n == b.page.maxw && e >= n) && b.checkContentSize(),
                b.noticeCursor()
            }
        }
        ,
        this.cancelScroll = function() {
            return b.timer && a(b.timer),
            b.timer = 0,
            b.bzscroll = !1,
            b.scrollrunning = !1,
            b
        ...
        this.doScrollBy = function(e, o) {
            var t = 0;
            if (t = o ? Math.floor((b.scroll.y - e) * b.scrollratio.y) : (b.timer ? b.newscrolly : b.getScrollTop(!0)) - e,
            b.bouncescroll) {
            ...
            return t < 0 && i <= 0 ? b.noticeCursor() : t > b.page.maxh && i >= b.page.maxh ? (b.checkContentSize(),
            b.noticeCursor()) : void b.doScrollTop(t)
        }
        ,
        this.doScrollLeftBy = function(e, o) {
            var t = 0;
            if (t = o ? Math.floor((b.scroll.x - e) * b.scrollratio.x) : (b.timer ? b.newscrollx : b.getScrollLeft(!0)) - e,
            b.bouncescroll) {
        ...
        this.doZoomIn = function(e) {
            if (!b.zoomactive) {
                ...
                z.isios4 && (b.zoomrestore.scrollTop = s(window).scrollTop(),
                ...
                return ("" == l || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(l)) && b.win.css("backgroundColor", "#fff"),
                b.rail.css({
                    zIndex: n + 101
                }),
                b.zoom.css({
    ...
    e.cssHooks.pageYOffset = {
        ...
        set: function(e, o) {
            ...
            return t && t.ishwscroll ? t.setScrollTop(parseInt(o)) : f.call(e, o),
            this
        }
    },
    ...
    s.cssHooks.pageXOffset = {
        ...
        set: function(e, o) {
            var t = s.data(e, "__nicescroll") || !1;
            return t && t.ishwscroll ? t.setScrollLeft(parseInt(o)) : g.call(e, o),
            this
        }
    },
    ...
    s.fn.niceScroll = function(e, o) {
        ...
        o.win = s(this));
        var r = !("doc"in o);
        return r || "win"in o || (o.win = s(this)),
        this.each(function() {
            var e = s(this).data("__nicescroll") || !1;
            e || (o.doc = r ? s(this) : o.doc,
            e = new p(o,s(this)),
    ...
    s.nicescroll || (s.nicescroll = new w,
    s.nicescroll.options = d)
});
