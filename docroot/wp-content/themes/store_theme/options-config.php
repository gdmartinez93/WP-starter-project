...
// Example: Section with fields inside
Redux::setSection( $opt_name, array(
    'title'                 => __('General','agathostechnology'),
    'id'                    => 'general_settings',
    'subsection'            => true,
    'customizer_width'      => '400px',
    'desc'                  => __('Configuraciones Generales', 'agathostechnology'),
    'fields'                => array(
        array(
            'id'       => 'general_settings_brand_logo',
            'type'     => 'media',
            'title'    => __( 'Logo', 'agathostechnology' ),
            'subtitle' => __( 'Seleccione el logo de su compañia', 'agathostechnology' ),
        ),
        array(
            'id'       => 'general_settings_social_facebook',
            'type'     => 'text',
            'title'    => __( 'Facebook', 'agathostechnology' ),
            'subtitle' => __( 'Especifique su cuenta de Facebook', 'agathostechnology' ),
        ),
        array(
            'id'       => 'general_settings_social_instagram',
            'type'     => 'text',
            'title'    => __( 'Instagram', 'agathostechnology' ),
            'subtitle' => __( 'Especifique su cuenta de Instagram', 'agathostechnology' ),
        ),
        array(
            'id'       => 'general_settings_contact_phone',
            'type'     => 'text',
            'title'    => __( 'Telefono', 'agathostechnology' ),
            'subtitle' => __( 'Especifique un telefono de contacto', 'agathostechnology' ),
        ),
        array(
            'id'       => 'general_settings_contact_mail',
            'type'     => 'text',
            'title'    => __( 'Correo electronico', 'agathostechnology' ),
            'subtitle' => __( 'Especifique su cuenta de correo', 'agathostechnology' ),
        ),
        array(
            'id'       => 'general_settings_contact_address',
            'type'     => 'text',
            'title'    => __( 'Dirección', 'agathostechnology' ),
            'subtitle' => __( 'Especifique su dirección de domicilio', 'agathostechnology' ),
        ),
    )
));

Redux::setSection( $opt_name, array(
    'title'                 => __('Inicio','agathostechnology'),
    'id'                    => 'contact',
    'subsection'            => true,
    'customizer_width'      => '400px',
    'fields'                => array(
        array(
            'id'       => 'home_slider_gallery',
            'type'     => 'gallery',
            'title'    => __( 'Slider', 'agathostechnology' ),
            'subtitle'    => __( 'Imagenes 2000px X 680px', 'agathostechnology' ),
        ),
        array(
            'id'             => 'divider_slider',
            'type'           => 'divide',
        ...
        array(
            ...
            'title'    => __( 'Producto Destacado 1', 'agathostechnology' ),
        ),
        array(
            'id'       => 'home_product_advertising_2',
            'type'     => 'select',
            'data'     => 'posts',
            'args'     => array(
                'post_type' => 'product',
            ...
            'title'    => __( 'Producto Destacado 2', 'agathostechnology' ),
        ),
    )
));
